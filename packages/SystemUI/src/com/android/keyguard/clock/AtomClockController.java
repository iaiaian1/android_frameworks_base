 ...
 */
public class AtomClockController implements ClockPlugin {
     ...
     */
    public AtomClockController(Resources res, LayoutInflater inflater,
    ...
    private void createViews() {
        mView = (ClockLayout) mLayoutInflater
                .inflate(R.layout.atom_xperience_clock, null);
    ...
    public String getTitle() {
        return mResources.getString(R.string.clock_title_atom_xperience_animation);
    }
