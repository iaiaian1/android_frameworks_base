 ...
 */
public class PacmanClockController implements ClockPlugin {
     ...
     */
    public PacmanClockController(Resources res, LayoutInflater inflater,
    ...
    private void createViews() {
        mView = (ClockLayout) mLayoutInflater
                .inflate(R.layout.pacman_xperience_animation, null);
    ...
    public String getTitle() {
        return mResources.getString(R.string.clock_title_pacman_animation);
    }
