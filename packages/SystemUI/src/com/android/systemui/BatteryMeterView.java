...
import static com.android.settingslib.graph.BatteryMeterDrawableBase.BATTERY_STYLE_NORMAL;
...
import static com.android.settingslib.graph.BatteryMeterDrawableBase.BATTERY_STYLE_CM_CIRCLE;
...
public class BatteryMeterView extends LinearLayout implements
    ...
    private final BatteryMeterDrawableBase mCustomDrawable;
    ...
    public BatteryMeterView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mCustomDrawable = new BatteryMeterDrawableBase(context, frameColor);
        atts.recycle();
    ...
    public void onBatteryLevelChanged(int level, boolean pluggedIn, boolean charging) {
        if (mLevel != level) {
            ...
            mCustomDrawable.setBatteryLevel(level);
        }
        if (mCharging != pluggedIn) {
            mCharging = pluggedIn;
            mDrawable.setCharging(mCharging);
            mCustomDrawable.setCharging(mCharging);
            updateShowPercent();
        } else {
            updatePercentText();
        }
    ...
    public void onPowerSaveChanged(boolean isPowerSave) {
        ...
        mCustomDrawable.setPowerSave(isPowerSave);
        updateShowPercent();
    }
    ...
    private void updateShowPercent() {
        ...
        final boolean showPercent = mShowBatteryPercent == 2
            ...
            if (mBatteryStyle == BATTERY_STYLE_HIDDEN) {
              ...
              mCustomDrawable.setShowPercent(drawPercentInside);
          }
      }
    ...
    private void scaleBatteryMeterViews() {
        ...
        int batteryWidth = mBatteryStyle == BATTERY_STYLE_CIRCLE || mBatteryStyle == BATTERY_STYLE_DOTTED_CIRCLE ||
                                                                    mBatteryStyle == BATTERY_STYLE_CM_CIRCLE ?
    ...
    public void updateBatteryStyle() {
        ...
        if (mBatteryStyle == BATTERY_STYLE_NORMAL) {
            ...
            mCustomDrawable.setMeterStyle(mBatteryStyle);
            mBatteryIconView.setImageDrawable(mCustomDrawable);
        }
    }
    ...
    private void updateColors(int foregroundColor, int backgroundColor, int singleToneColor) {
        ...
        mCustomDrawable.setColors(foregroundColor, backgroundColor);
