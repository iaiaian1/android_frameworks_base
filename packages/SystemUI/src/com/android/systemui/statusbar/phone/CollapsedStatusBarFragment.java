...
public class CollapsedStatusBarFragment extends Fragment implements CommandQueue.Callbacks {
    ...
    private class XPerienceSettingsObserver extends ContentObserver {
        XPerienceSettingsObserver(Handler handler) {
            super(handler);
        }
    ...
    private XPerienceSettingsObserver mXPerienceSettingsObserver = new XPerienceSettingsObserver(mHandler);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mXPerienceSettingsObserver.observe();
    ...
    public void showSystemIconArea(boolean animate) {
        ...
        if (mShowLogo == 2) {
            animateShow(mXPerienceLogoRight, animate);
        }
    }
