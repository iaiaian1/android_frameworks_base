...
import static android.os.BatteryManager.EXTRA_CHARGE_TURBO;
...
public class BatteryStatus {
    ...
    public static final int CHARGING_CHARGE_TURBO = 4;
    ...
    public BatteryStatus(int status, int level, int plugged, int health,
            ...
            int maxChargingWattage, float temperature, boolean dashChargeStatus, boolean chargeTurboStatus, boolean present) {
        this.status = status;
        this.level = level;
